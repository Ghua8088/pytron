...
class MenuItem:
    def __init__(self, label: str, callback: Optional[Callable] = None, shortcut: str = "", submenu: Optional[Menu] = None, is_separator: bool = False):
        self.label = label
...
class MenuBar:
    ...
    def build_for_windows(self, hwnd):
        ...
        from .platforms.windows_ops.constants import MF_STRING, MF_POPUP, MF_SEPARATOR, MF_GRAYED, MF_CHECKED
        ...
        def _build_recursive(menu_obj, is_top=False):
            ...
            for item in menu_obj.items:
                ...
                if item.submenu:
                    ...
                    if not item.enabled: flags |= MF_GRAYED
