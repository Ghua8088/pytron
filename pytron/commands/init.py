        ...
        try:
            ...
            if package_json_path.exists():
                try:
                    ...
                    # Add pytron-client & pytron-UI
                    pkg_data["dependencies"]["pytron-client"] = "latest"
                    pkg_data["dependencies"]["pytron-ui"] = "latest"
...
""")
    ...
    # Create agents.md
    (target / "agents.md").write_text(TEMPLATE_AGENTS, encoding="utf-8")
    log("Added agents.md for AI-Native development", style="success")
